<?php
    ...
    $author_info = get_the_author_meta( 'netfix_write_by');
    $facebook_url = get_the_author_meta( 'netfix_facebook' );
    $twitter_url = get_the_author_meta( 'netfix_twitter' );
    $linkedin_url = get_the_author_meta( 'netfix_linkedin' );
    $instagram_url = get_the_author_meta( 'netfix_instagram' );
    $netfix_url = get_the_author_meta( 'netfix_youtube' );
    $netfix_write_by = get_the_author_meta( 'netfix_write_by' );
