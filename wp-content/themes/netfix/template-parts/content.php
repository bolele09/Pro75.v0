...
?>
    ...
    <article id="post-<?php the_ID();?>" <?php post_class( 'standard-blog-item mb-50 format-image' );?> data-wow-delay=".3s">
...
<?php
    ...
    <article id="post-<?php the_ID();?>" <?php post_class( 'standard-blog-item mb-50 format-image' );?> data-wow-delay=".3s">
        ...
        <div class="standard-blog-content">
            ...
            <a href="<?php the_permalink();?>" class="btn transparent-btn b-border-btn"><?php print esc_html( $netfix_blog_btn );?></a>
            <?php endif;?>
        </div>
    </article>
<?php
