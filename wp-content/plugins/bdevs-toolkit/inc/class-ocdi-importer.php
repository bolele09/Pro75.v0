...
class OCDI_Demo_Importer {
    ...
    public function import_files_config() {
        ...
        $home_prevs = [
            'fastpro_home_1' => [
                ...
                'preview_link' => 'https://bdevs.net/wp/netfix/',
            ],
            'fastpro_home_2' => [
                ...
                'preview_link' => 'https://bdevs.net/wp/netfix/home-02/',
            ],
        ];
    ...
    private function assign_frontpage_id( $selected_import ) {
		...
		if($selected_import['import_page_name'] == "home-02")
		{
			$front_page = get_page_by_title('Home 02');
		}
		else 
		{
	    ...
	    if ( class_exists( 'woocommerce' ) ) {
	        update_option( 'woocommerce_shop_page_id', '6' );
	        update_option( 'woocommerce_cart_page_id', '7' );
	        update_option( 'woocommerce_checkout_page_id', '8' );
	        update_option( 'woocommerce_myaccount_page_id', '9' );
	    }
	}
