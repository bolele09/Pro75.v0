...
class Featured_List extends BDevs_El_Widget {
    ...
    protected function render() {
        ...
        ?>
        <section class="features__area wow fadeInUp2" data-wow-delay=".5s">
            <div class="container">
                <div class="features__inner fix">
                    <div class="row no-gutters">
                        ...
                        <div class="col-xl-2 col-lg-2 col-md-4 col-sm-4">
                            <div class="features__item text-center zf-item bdevs-el-content">
                                ...
                                <div class="features__content">
                                    ...
                                    <?php if( $slide['title'] ) : ?>
                                    <h3 class="zf-title bdevs-el-title"><?php echo bdevs_element_kses_basic( $slide['title'] ); ?></h3>
                                    <?php endif; ?>
                                    <?php if( $slide['f_url'] ) : ?>
