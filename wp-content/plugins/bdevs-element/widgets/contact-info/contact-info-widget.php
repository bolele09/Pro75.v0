...
class Contact_info extends BDevs_El_Widget
{
    ...
    protected function render()
    {
        ...
        $this->add_render_attribute('button', 'class', 'btn s-btn map-btn bdevs-el-btn');
        $this->add_link_attributes('button', $settings['button_link']);

        $title = bdevs_element_kses_basic($settings['title']);

        if (!empty($settings['map_image']['id'])) {
            $map_image = wp_get_attachment_image_url($settings['map_image']['id'], $settings['thumbnail_size']);
        }
        ?>
        ...
        <div class="faq-map-area">
            ...
            <div class="faq-map text-center">
                <?php if (!empty($map_image)): ?>
                    <img src="<?php echo esc_url($map_image); ?>" alt="img">
                <?php endif; ?>
