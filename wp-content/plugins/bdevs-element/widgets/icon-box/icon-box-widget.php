...
class Icon_Box extends BDevs_El_Widget {
    ...
    protected function register_content_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __('Back Image', 'bdevselement'),
                'tab' => Controls_Manager::TAB_CONTENT,
                'condition' => [
    ...
    protected function render() {
        ...
        ?>
            ...
            <div class="single-department d-none <?php echo esc_attr( $thumb_small ) ; ?>">
                <div class="thumb">
                    <?php if ( $settings['type'] === 'image' && ( $settings['image']['url'] || $settings['image']['id'] ) ) :
                    $this->get_render_attribute_string( 'image' );
                    $settings['hover_animation'] = 'disable-animation'; // hack to prevent image hover animation
            ...
            <div class="services-item service-item-two">
        ...
        if (!empty($settings['back_image']['id'])) {
            $back_image = wp_get_attachment_image_url($settings['back_image']['id'], $settings['thumbnail_size']);
        }
        ...
        <div class="services-item" data-background="<?php echo esc_url($back_image); ?>">
            <div class="services-icon">
                <?php if ( $settings['type'] === 'image' && ( $settings['image']['url'] || $settings['image']['id'] ) ) :
                $this->get_render_attribute_string( 'image' );
