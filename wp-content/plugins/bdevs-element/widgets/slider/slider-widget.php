...
class Slider extends BDevs_El_Widget {
    ...
    protected function register_content_controls() {
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .single-slider::before,{{WRAPPER}}.slider-bg::before',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [ 
                    '{{WRAPPER}} .single-slider::before,{{WRAPPER}} .slider-bg::before' => 'opacity: {{SIZE}};',
                ]
            ]
        );
        ...
        $repeater->add_control(
            ...
            [
                'type' => Controls_Manager::TEXTAREA,
                'label_block' => true,
                'label' => __( 'Slider Info', 'bdevselement' ),
                'default' => __( 'Slider Info', 'bdevselement' ),
                'placeholder' => __( 'Type slider info here', 'bdevselement' ),
                'dynamic' => [
                    'active' => true,
                ]
            ]
    ...
    protected function render() {
        ...
        $this->add_render_attribute( 'button', 'class', 'ddd' );
        ...
        $this->add_render_attribute( 'button', 'class', 'bdevs-el-btn' );
            ...
            <section class="slider-area">
                <div class="slider-active">
                 ...
                 <?php foreach ( $settings['slides'] as $key => $slide ) :
                        ...
                        $this->add_render_attribute( 'button_'. $key, 'class', 'btn s-btn bdevs-el-btn' );
                        $this->add_render_attribute( 'button_'. $key, 'data-animation', 'fadeInUp' );
                        $this->add_render_attribute( 'button_'. $key, 'data-delay', '1s' );
                        $this->add_render_attribute( 'button_'. $key, 'data-duration', '1.2s' );
                        $this->add_render_attribute( 'button_'. $key, 'href', $slide['button_link']['url'] );
                    ?>

                    <div class="single-slider slider-bg" data-background="<?php print esc_url($image); ?>">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-7 col-md-9">
                                    <div class="banner-content">
                                        <h2 class="title bdevs-el-title" data-animation="fadeInUp" data-delay=".2s" data-duration="1.2s"><?php echo bdevs_element_kses_basic( $slide['title'] ); ?></h2>

                                        <ul class="slider-services-list">
                                            <?php echo wp_kses_post( $slide['slider_info'] ); ?>
                                        </ul>
