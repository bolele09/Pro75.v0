            ...
            <div class="faq-wrapper">
                <div class="accordion" id="accordionExample">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingSix_<?php echo esc_attr($id); ?>">
                            <button class="accordion-button collapsed <?php echo esc_attr($collapsed_tab); ?>" 
                            type="button" 
                            data-bs-toggle="collapse" 
                            data-bs-target="#collapseSix_<?php echo esc_attr($id); ?>" 
                            aria-expanded="<?php echo esc_attr($area_expanded); ?>" 
                            aria-controls="collapseSix_<?php echo esc_attr($id); ?>">
                                <?php echo bdevs_element_kses_basic($slide['tab_title']); ?>
                            </button>
                        </h2>
                        <div id="collapseSix_<?php echo esc_attr($id); ?>" 
                        class="accordion-collapse collapse <?php echo esc_attr($active_show_tab); ?>" 
                        aria-labelledby="headingSix_<?php echo esc_attr($id); ?>"
            ...
            <div class="faq-wrapper">
                <div class="accordion" id="accordionExample">
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseOne_<?php echo esc_attr($id); ?>" 
                        class="accordion-collapse collapse <?php echo esc_attr($active_show_tab); ?>" 
                        aria-labelledby="headingOne_<?php echo esc_attr($id); ?>" 
                        data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                <?php echo bdevs_element_kses_basic($slide['tab_content_info']); ?>
                            </div>
