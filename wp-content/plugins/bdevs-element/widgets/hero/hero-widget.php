...
class Hero extends BDevs_El_Widget {
    ...
    protected function register_content_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'placeholder' => __( 'Enter Hero Title', 'bdevselement' ),
                'dynamic' => [
                    'active' => true,
                ]
            ]
       ...
       $this->add_control(
            'hero_price',
            [
                'label' => __( 'Hero Price', 'bdevselement' ),
                'label_block' => true,
                'type' => Controls_Manager::TEXT,
                'default' => __( 'Hero Price', 'bdevselement' ),
                'placeholder' => __( 'Enter Hero Price', 'bdevselement' ),
                'dynamic' => [
                    'active' => true,
                ]
            ]
       ...
       $this->add_control(
            'phone_level',
            [
                'label' => __( 'Phone Level', 'bdevselement' ),
                'label_block' => true,
                'type' => Controls_Manager::TEXT,
                'default' => __( 'Customer Service:', 'bdevselement' ),
                'placeholder' => __( 'Enter Phone Level', 'bdevselement' ),
                'dynamic' => [
                    'active' => true,
                ],
                'condition' => [
       ...
       $this->add_control(
            ...
            [
                ...
                'label_block' => true,
                'type' => Controls_Manager::TEXT,
                'default' => __( '+1 872 923 025', 'bdevselement' ),
                'placeholder' => __( 'Enter Phone Number', 'bdevselement' ),
                'dynamic' => [
                    'active' => true,
                ],
                'condition' => [
    ...
    protected function render() {
        ...
        <?php else:
        $this->add_inline_editing_attributes( 'title', 'basic' );
        $this->add_render_attribute( 'title', 'class', 'title wow fadeInUp bdevs-el-title' );
        $this->add_render_attribute( 'title', 'data-wow-delay', '.2s' );

        $this->add_inline_editing_attributes( 'description', 'intermediate' );
        $this->add_render_attribute( 'description', 'class', 'bdevs-el-content' );

        if ( !empty($settings['button_link']) ) {
            $this->add_render_attribute( 'button', 'class', 'btn s-btn wow fadeInUp bdevs-el-btn' );
        ...
        <section class="banner-area banner-bg">
                ...
                <div class="row">
                    <div class="col-xl-5 col-lg-6 col-md-9">
                        <div class="banner-content bdevs-el-content">
                            ...
                            <?php if ( $settings['description'] ) : ?>
                            <p class="wow fadeInUp" data-wow-delay=".4s"><?php echo bdevs_element_kses_intermediate( $settings['description'] ); ?></p>
                            <?php endif; ?>

                            <?php if ( $settings['hero_price'] ) : ?>
                            <div class="banner-price wow fadeInUp" data-wow-delay=".6s">
                                <h3 class="price"><?php echo wp_kses_post( $settings['hero_price'] ); ?></h3>
                            </div>
                            <?php endif; ?>
            ...
            <div class="banner-phone">
                ...
                <div class="content">
                    <span><?php echo wp_kses_post( $settings['phone_level'] ); ?></span>
                    <h5 class="number"><a href="tel:<?php echo esc_url( $settings['phone_number'] ); ?>"><?php echo wp_kses_post( $settings['phone_number'] ); ?></a></h5>
                </div>
            </div>
            <?php endif; ?>
        </section>
